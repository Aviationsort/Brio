...
export interface UIStrings {
  ...
  placeholderRegistration: string;
  placeholderAirline: string;
...
export const t: UIStrings = {
  ...
  loading: 'Loading',
  placeholderRegistration: 'e.g. G-NLPD',
  placeholderAirline: 'e.g. British Airways',
  placeholderAircraftType: 'e.g. Boeing 787-10',
  placeholderSpecialLivery: 'e.g. Retro, Honami...',
  placeholderSelectDate: 'Select date',
  expectedFolderStructure: 'Expected Folder Structure',
  folderStructureHint: 'Organize your folder as: FOLDER_NAME/AIRLINE/AIRCRAFT_TYPE/FILENAME',
  continueToSelectFolder: 'Continue to Select Folder',
  exit: 'Exit',
  uploadPhotoDetails: 'Upload Photo Details',
  ...
  placeholderBroadcastMessage: 'Broadcast a message...',
  placeholderNoteTitle: 'Note title...',
  placeholderEncryptedNotes: 'Your encrypted note here...',
  placeholderTagsComma: 'tags, comma, separated',
  placeholderUrgentTask: 'Urgent task...',
  placeholderPlaceNote: 'Drop a note here...',
  placeholderSearchApps: 'Search apps & features',
  placeholderIcaoCode: 'ICAO code / airport...',
