          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            {telemetry.gpuName && (
              <div className="p-4 bg-zinc-950 border border-white/10 rounded-2xl">
                ...
                <p className="text-sm font-bold text-purple-300 mt-1 break-all">{telemetry.gpuName}</p>
            ...
            {telemetry.gpuMemoryTotalMb && (
              <div className="p-4 bg-zinc-950 border border-white/10 rounded-2xl">
                ...
                <p className="text-2xl font-bold text-purple-400 mt-1">{telemetry.gpuMemoryTotalMb} MB</p>
              </div>
            )}
            {telemetry.cpuName && (
              <div className="p-4 bg-zinc-950 border border-white/10 rounded-2xl">
            ...
            {telemetry.romTotalGb && (
              <div className="p-4 bg-zinc-950 border border-white/10 rounded-2xl">
                ...
                <p className="text-2xl font-bold text-amber-300 mt-1">{telemetry.romTotalGb} GB</p>
