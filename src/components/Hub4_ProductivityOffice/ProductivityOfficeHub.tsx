    ...
    <div className="space-y-6">
      ...
      <div className={`flex items-center gap-2 p-2 ${navBase} rounded-3xl overflow-x-auto no-scrollbar`}>
        <button
          ...
          className={`ife-btn flex items-center gap-2.5 px-5 py-3 rounded-2xl text-xs font-bold transition-all shrink-0 cursor-pointer ${
            subTab === 'office'
      ...
      <div className="transition-all duration-300">
        ...
        {subTab === 'editor' && (
          <div className={`${navBase} rounded-3xl p-8 shadow-2xl space-y-5 aero-panel aero-glossy`}>
            <div className="flex items-center justify-between pb-4 border-b border-white/10">
              <div className="flex items-center gap-3">
                <span className="p-2.5 flash-panel border border-red-500/30 rounded-xl text-red-400">
            ...
            <div className="flex items-center gap-2">
              <button className="ife-btn p-2.5 text-zinc-300 rounded-xl border border-white/10 transition-all">
